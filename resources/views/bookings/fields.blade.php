...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <div class="form-check">
            <input name="is_paid" value="{{ $booking->is_paid ? '1' : '0' }}" type="checkbox" class="form-check-input"/>
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input value="{{ $booking->notes ?? '' }}" name="notes" type="text" class="form-control" placeholder="Notes"/>
